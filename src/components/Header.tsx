      ...
      subItems: [
        {
          ...
          links: [
            ...
            { name: "FSSAI Annual Return", href: "/startup/fssai-annual-return" },
            { name: "FSSAI Product Approval", href: "/startup/fssai-product-approval" },
        ...
        },
        {
          ...
          links: [
            { name: "Company Registration", href: "/startup/company-registration" },
            { name: "LLP Registration", href: "/startup/llp-registration" },
            { name: "Public Limited Company Registration", href: "/startup/public-limited" },
            { name: "One Person Company Registration", href: "/startup/opc" },
            { name: "Partnership Firm Registration", href: "/startup/partnership" },
            { name: "Sole Proprietorship Registration", href: "/startup/sole-proprietorship" },
            { name: "Nidhi Company Registration", href: "/startup/nidhi" },
            { name: "Producer Company Registration", href: "/startup/producer" },
            { name: "Sole Proprietorship to Pvt. Ltd. Company", href: "/startup/prop-to-pvt" },
            { name: "Conversion of Pvt. Ltd. to Public Limited", href: "/startup/pvt-to-public" },
            { name: "Indian Subsidiary Company Registration", href: "/startup/indian-subsidiary" },
            { name: "Conversion of LLP to Private Company", href: "/startup/llp-to-pvt" },
            { name: "Partnership Firm into Pvt. Ltd. Company", href: "/startup/partnership-to-pvt" },
            { name: "Carbon Black Manufacturing", href: "/startup/carbon-black" },
            { name: "Green Hydrogen Plant", href: "/startup/green-hydrogen" },
            { name: "Green Ammonia Plant", href: "/startup/green-ammonia" },
            { name: "Synthetic Rubber Business", href: "/startup/synthetic-rubber" },
            { name: "Paper and Paperboard Packaging Industry", href: "/startup/paper-packaging" },
            { name: "Fermentation Industry", href: "/startup/fermentation" },
            { name: "Renewable Energy Business", href: "/startup/renewable-energy" },
          ],
        },
        {
          title: "Secretarial Compliances",
          links: [
            { name: "Winding Up of Private Limited Company", href: "/startup/winding-up" },
            { name: "Closing a Limited Liability Partnership", href: "/startup/llp-closing" },
            { name: "Annual Compliance of a Pvt. Ltd. Company", href: "/startup/annual-compliance" },
            { name: "Annual Filing for LLP", href: "/startup/llp-filing" },
            { name: "Event Based Compliances in a Company", href: "/startup/event-based" },
            { name: "Change in Object Clause", href: "/startup/change-object" },
            { name: "Appointment and Resignation of Directors", href: "/startup/directors-change" },
            { name: "Change in Name Clause", href: "/startup/change-name" },
            { name: "Removal of Director", href: "/startup/remove-director" },
            { name: "Nidhi Company Compliance", href: "/startup/nidhi-compliance" },
            { name: "Section 8 Company Compliance", href: "/startup/section8-compliance" },
            { name: "NBFC Compliance", href: "/startup/nbfc-compliance" },
            { name: "Change in Registered Office", href: "/startup/change-office" },
            { name: "Change in Share Capital", href: "/startup/change-capital" },
            { name: "Revival of Struck Off Companies", href: "/startup/revival" },
            { name: "MCA Compliance", href: "/startup/mca-compliance" },
            { name: "Change in Directors", href: "/startup/change-directors" },
            { name: "Change in LLP Agreement", href: "/startup/change-llp-agreement" },
        ...
        },
        {
          title: "IT Services",
          links: [
            { name: "Web Development Company", href: "/startup/web-development" },
          ],
        },
        {
          title: "Government Licenses",
          links: [
            { name: "Shop & Establishment License", href: "/startup/shop-license" },
            ...
            { name: "FIFP Approval for Telecom", href: "/startup/fifp-telecom" },
            { name: "Halal Certification", href: "/startup/halal-certification" },
            { name: "Homologation Certificate in India", href: "/startup/homologation" },
            { name: "Vehicle Type Approval Certificate in India", href: "/startup/vehicle-type-approval" },
            { name: "IMEI Number Registration", href: "/startup/imei-registration" },
            { name: "IMEI Certificate for Import of Mobile Handsets", href: "/startup/imei-certificate" },
            { name: "IMEI Certificate Generation", href: "/startup/imei-certificate-generation" },
          ],
        },
        {
          ...
          links: [
            ...
            { name: "RERA Registration for Agents", href: "/startup/rera-agent" },
            { name: "RERA Registration For Promoters", href: "/startup/rera-promoter" },
            ...
            { name: "World Manufacturer Identifier (WMI) Code", href: "/startup/wmi-code" },
            { name: "Telemarketing Registration in India", href: "/startup/telemarketing" },
            { name: "Trusted Telecom Approval", href: "/startup/trusted-telecom" },
            { name: "Get Uplinking or Downlinking Channels Permission in India", href: "/startup/uplink-downlink" },
            { name: "PM-WANI Registration", href: "/startup/pm-wani" },
            { name: "Flipkart Seller Registration", href: "/startup/flipkart-seller" },
            { name: "Sanitary Import Permit", href: "/startup/sanitary-import" },
            { name: "NPOP Certification", href: "/startup/npop" },
            { name: "Coconut Board Registration", href: "/startup/coconut-board" },
        ...
        },
        {
          ...
          links: [
            ...
            { name: "Section 8 Company Registration", href: "/startup/section-8" },
            ...
            { name: "Strike off Section 8 Companies", href: "/startup/strikeoff-section8" },
            ...
            { name: "Trust Annual Compliance", href: "/startup/trust-compliance" },
        ...
        },
        {
          ...
          links: [
            ...
            { name: "ISO 21101:2014 Certification", href: "/startup/iso-21101" },
            { name: "ISO 37001:2016 Certification", href: "/startup/iso-37001" },
            { name: "ISO 27001 ISMS Certification", href: "/startup/iso-27001" },
      ...
      subItems: [
        {
          ...
          links: [
            { name: "Environmental Clearance", href: "/environmental/clearance" },
      ...
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
        <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <Image
            ...
            className="h-8"
          />
          <span className="self-center text-2xl font-semibold whitespace-nowrap">DoStartup</span>
        </Link>
        ...
        {/* Desktop Navigation */}
        <div id="mega-menu" className="items-center justify-between hidden w-full md:flex md:w-auto">
            ...
            {menuItems.map((item, index) => (
              <li key={index} className="relative group">
                {item.href ? (
                  <Link 
                    href={item.href} 
                    className="block py-2 px-3 rounded hover:bg-slate-700 md:hover:bg-transparent md:hover:text-emerald-300 md:p-0"
                  >
                    {item.title}
                  </Link>
                ) : (
                  <>
                    <button 
                      ...
                      className="flex items-center justify-between w-full py-2 px-3 rounded hover:bg-slate-700 md:hover:bg-transparent md:border-0 md:hover:text-emerald-300 md:p-0 md:w-auto"
                    >
                      {item.title}
                      <svg 
                    ...
                    {openMainItem === item.title && (
                      <div className="absolute left-0 mt-0 w-56 bg-slate-800 border border-gray-700 rounded-lg shadow-lg z-10">
                        <ul className="py-1">
                          {item.subItems.map((subItem, subIndex) => (
                            <li key={subIndex}>
                              <button
                                onClick={() => toggleSubItem(`${item.title}-${subItem.title}`)}
                                className="flex justify-between items-center w-full px-4 py-2 hover:bg-slate-700 hover:text-emerald-300 text-left"
                              >
                                {subItem.title}
                                {subItem.links && (
                                  <svg 
                              ...
                              {/* Desktop Dropdown - Second Level */}
                              {openSubItem === `${item.title}-${subItem.title}` && subItem.links && (
                                <div className="absolute left-full top-0 ml-1 w-56 bg-slate-800 border border-gray-700 rounded-lg shadow-lg z-10">
                                  <ul className="py-1 max-h-96 overflow-y-auto">
                                    {subItem.links.map((link, linkIndex) => (
                                      <li key={linkIndex}>
                                        <Link 
                                          href={link.href}
                                          className="block px-4 py-2 hover:bg-slate-700 hover:text-emerald-300 text-sm"
                                        >
                                          {link.name}
                                        </Link>
                                      </li>
                          ...
                          {item.subItems.map((subItem, subIndex) => (
                            <div key={subIndex}>
                              ...
                              >
                                ...
                                {subItem.links && (
                                  <svg 
                                    className={`w-2.5 h-2.5 ms-2.5 transition-transform ${openSubItem === `${item.title}-${subItem.title}` ? 'rotate-180' : ''}`}
                                    aria-hidden="true" 
                                    xmlns="http://www.w3.org/2000/svg" 
                                    fill="none" 
                                    viewBox="0 0 10 6"
