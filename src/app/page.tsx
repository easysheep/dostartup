...
const processSteps = [
  {
    title: "Consultation",
    description: "Schedule a free consultation with our experts to understand your business needs.",
    icon: "💼",
  },
  {
  ...
  },
  {
    ...
    description: "Our team files your application with the relevant authorities.",
    icon: "📝",
  },
  {
    title: "Verification & Processing",
    description: "Track application status in real-time as we handle verifications.",
    icon: "✅",
  },
  {
    title: "Certificate Delivery",
    description: "Receive your digital certificates and physical copies if requested.",
    icon: "🏆",
  },
];
...
const faqs = [
  {
    ...
    answer: "Typically, Private Limited company registration takes 7-10 working days from document submission. One Person Company (OPC) registration usually takes 5-7 working days. Timelines may vary based on government processing speeds and document completeness.",
  },
  {
    question: "What documents are required for GST registration?",
    answer: "For GST registration, you'll need PAN card, Aadhaar card, proof of business address (electricity bill, rent agreement, etc.), bank account details with statements, photographs, and business incorporation documents. Our team will guide you through the entire documentation process.",
  },
  {
    question: "What are the benefits of MSME registration?",
    answer: "MSME registration provides several benefits including priority sector lending, lower interest rates, protection against delayed payments, tax exemptions, subsidies for patent registration, ISO certification reimbursement, and eligibility for government tenders and schemes.",
  },
  {
    question: "Can I convert my business structure later?",
    answer: "Yes, you can convert your business structure as your business grows. We offer conversion services for OPC to Private Limited, Proprietorship to LLP, and other business structure transitions. Our experts will guide you through the legal and compliance requirements for a smooth transition.",
  },
  {
    question: "What ongoing compliances do I need to maintain after registration?",
    answer: "After registration, businesses need to maintain various compliances including annual filings, GST returns, income tax returns, maintaining statutory registers, conducting board meetings, and fulfilling industry-specific requirements. Our compliance management services can help you stay on track.",
  },
  {
    question: "Do you provide post-registration support?",
    answer: "Absolutely! We offer comprehensive post-registration support including compliance management, annual filings, tax consultations, and business advisory services. Our goal is to be your long-term compliance partner throughout your business journey.",
  },
];
...
export default function Home() {
  ...
  const toggleFaq = (index: number) => {
    setExpandedFaq((prevExpandedFaq) => (prevExpandedFaq === index ? null : index));
  };
    ...
    <div className="min-h-screen bg-white text-gray-800 scroll-smooth">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          >
            Trusted by 2000+ businesses across India for fast, reliable, and cost-effective business registration and compliance services.
          </motion.p>
          <motion.form 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Comprehensive business registration and compliance solutions to keep your business legally sound and operationally efficient.
            </p>
          </div>
      ...
      <section ref={processRef} className="py-20 bg-gradient-to-b from-white to-emerald-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">How It Works</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures that your business registration and compliance needs are handled efficiently and professionally.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-3">
            {[
              {
                quote: "DoStartup made my company registration process incredibly smooth. Their team guided me through every step and handled all the paperwork efficiently.",
                name: "Rahul Sharma",
                company: "TechVision Solutions",
                image: "/testimonial1.jpg"
              },
              {
                quote: "As a first-time entrepreneur, I was nervous about the legal requirements. DoStartup's experts simplified everything and got my MSME registration done in record time!",
                name: "Priya Patel",
                company: "Organic Foods Co.",
                image: "/testimonial2.jpg"
              },
              {
                quote: "The team at DoStartup helped me navigate the complex GST registration process with ease. Their post-registration support has been exceptional.",
                name: "Amit Kumar",
              ...
              >
                <div className="absolute -top-6 left-6 text-5xl text-emerald-500">"</div>
      ...
      <section className="py-20 bg-white text-center px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-4 text-lg text-gray-600">
            With a team of experienced legal and business consultants, we've helped over 2000 businesses navigate the complex world of regulations and compliance.
          </p>
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="text-3xl text-emerald-500 mb-2">🏆</div>
              <h3 className="text-xl font-semibold mb-2">Our Mission</h3>
              <p className="text-gray-600">To simplify business compliance for entrepreneurs, allowing them to focus on growth.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="text-3xl text-emerald-500 mb-2">👁️</div>
              <h3 className="text-xl font-semibold mb-2">Our Vision</h3>
              <p className="text-gray-600">To become India's most trusted business compliance partner for startups and SMEs.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="text-3xl text-emerald-500 mb-2">💎</div>
              <h3 className="text-xl font-semibold mb-2">Our Values</h3>
              <p className="text-gray-600">Transparency, expertise, customer-centricity, and continuous innovation.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              We combine expertise, technology, and personalized service to provide the best business registration experience.
            </p>
          </div>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { 
                ...
                icon: "📘",
                description: "Our team of experienced consultants provides expert guidance throughout your business journey."
              },
              { 
                title: "Fast Processing", 
                icon: "⚡",
                description: "We prioritize speed without compromising on quality, ensuring quick turnaround times."
              },
              { 
                title: "Affordable Pricing", 
                icon: "💰",
                description: "Transparent pricing with no hidden charges, making compliance accessible for businesses of all sizes."
              },
              { 
                title: "Reliable Support", 
                icon: "📞",
                description: "Dedicated customer support available to assist you with any questions or concerns."
              },
            ].map((item, idx) => (
              <motion.div
                key={idx}
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                ...
                <p className="text-emerald-100 text-lg font-medium mt-2">{item.label}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white text-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              With years of experience in business compliance, we offer expert services across various domains.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "We offer expert legal support for startups, helping them navigate the complex legal landscape.",
                icon: "⚖️"
              },
              {
                title: "Trademark & IP Services",
                description: "Protect your intellectual property with our comprehensive trademark and IP registration services.",
                icon: "™️"
              },
              {
                title: "Tax & Financial Compliance",
                description: "Stay compliant with all tax regulations with our financial compliance services.",
                icon: "📊"
              },
              {
                title: "FSSAI & ISO Certifications",
                description: "Get certified with industry-standard certifications to enhance your business credibility.",
                icon: "🏅"
              },
              {
                title: "Private/Public Ltd Incorporation",
                description: "Incorporate your business with the right structure to support your growth ambitions.",
                icon: "🏢"
              },
              {
                title: "Corporate Governance",
                description: "Establish robust corporate governance frameworks for sustainable business operations.",
                icon: "📑"
              }
            ].map((expertise, i) => (
              <motion.div
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Popular Registration Packages</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Comprehensive packages designed to meet your specific business needs at competitive prices.
            </p>
          </div>
          <div className="grid gap-10 md:grid-cols-3">
            {[
              { 
                ...
                features: ["Private Limited Registration", "GST Registration", "MSME Certificate", "1-hour Business Consultation", "Annual Compliance Calendar"]
              },
              { 
                name: "MSME & IEC Duo", 
                price: "₹2,499", 
                desc: "Perfect for small businesses & exporters",
                features: ["MSME Registration", "IEC Certificate", "Export Documentation Guide", "Import-Export Consultation", "Compliance Support"]
              },
              { 
                name: "Complete Compliance Kit", 
                price: "₹8,999", 
                desc: "Company + GST + Annual Filings",
                features: ["Private Limited Registration", "GST Registration", "Annual ROC Filings", "GST Returns (1 Year)", "Dedicated Relationship Manager"]
              }
            ].map((pack, i) => (
              <motion.div
                key={i}
              ...
              >
                <div className="mb-auto">
                  ...
                  <p className="text-emerald-600 font-bold text-3xl mb-4">{pack.price}</p>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-emerald-50">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Find answers to common questions about business registration and compliance.
            </p>
          </div>
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <motion.div 
                key={i} 
                className={`border border-gray-200 rounded-lg overflow-hidden ${expandedFaq === i ? 'shadow-md' : ''}`}
                initial={false}
                animate={{ backgroundColor: expandedFaq === i ? 'rgb(240, 253, 244)' : 'rgb(255, 255, 255)' }}
              ...
              >
                ...
                >
                  ...
                  <svg 
                    className={`w-5 h-5 text-emerald-600 transition-transform duration-300 ${expandedFaq === i ? 'rotate-180' : ''}`}
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="mb-8 text-lg max-w-3xl mx-auto">
              Get in touch with our experts today and take the first step towards building a compliant and successful business!
            </p>
      ...
      <section className="py-20 bg-white text-center overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mb-10">
            We collaborate with leading organizations to provide the best services to our clients.
          </p>
      ...
      <section className="py-20 bg-gray-900 text-white text-center">
        <div className="max-w-xl mx-auto px-6">
          ...
          <p className="mt-4 text-lg text-gray-300 mb-8">
            Subscribe to our newsletter for legal updates, compliance reminders, and startup insights.
          </p>
          ...
          <p className="text-xs text-gray-400 mt-4">
            By subscribing, you agree to receive emails from DoStartup. You can unsubscribe at any time.
          </p>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12">
            <div className="space-y-4">
              <h4 className="font-semibold text-lg border-b border-gray-700 pb-2 mb-4">Company</h4>
              <ul className="space-y-3">
                <li><a href="/about" className="text-gray-300 hover:text-emerald-400 transition-colors">About Us</a></li>
                <li><a href="/team" className="text-gray-300 hover:text-emerald-400 transition-colors">Our Team</a></li>
                <li><a href="/careers" className="text-gray-300 hover:text-emerald-400 transition-colors">Careers</a></li>
            ...
            <div className="space-y-4">
              <h4 className="font-semibold text-lg border-b border-gray-700 pb-2 mb-4">Registrations</h4>
              <ul className="space-y-3">
                <li><a href="/register/private-limited-company" className="text-gray-300 hover:text-emerald-400 transition-colors">Private Ltd</a></li>
                <li><a href="/register/one-person-company" className="text-gray-300 hover:text-emerald-400 transition-colors">OPC</a></li>
                <li><a href="/register/llp" className="text-gray-300 hover:text-emerald-400 transition-colors">LLP</a></li>
                <li><a href="/register/msme" className="text-gray-300 hover:text-emerald-400 transition-colors">MSME</a></li>
                <li><a href="/register/gst" className="text-gray-300 hover:text-emerald-400 transition-colors">GST</a></li>
              </ul>
            </div>
            <div className="space-y-4">
              <h4 className="font-semibold text-lg border-b border-gray-700 pb-2 mb-4">Certifications</h4>
              <ul className="space-y-3">
                <li><a href="/register/iso" className="text-gray-300 hover:text-emerald-400 transition-colors">ISO</a></li>
                <li><a href="/register/fssai" className="text-gray-300 hover:text-emerald-400 transition-colors">FSSAI</a></li>
                <li><a href="/register/iec" className="text-gray-300 hover:text-emerald-400 transition-colors">IEC</a></li>
                <li><a href="/register/trademark" className="text-gray-300 hover:text-emerald-400 transition-colors">Trademark</a></li>
                <li><a href="/register/psara" className="text-gray-300 hover:text-emerald-400 transition-colors">PSARA</a></li>
              </ul>
            </div>
            <div className="space-y-4">
              <h4 className="font-semibold text-lg border-b border-gray-700 pb-2 mb-4">Contact Us</h4>
              <div className="space-y-3 text-gray-300">
                <p className="flex items-start">
                  <svg className="h-5 w-5 mr-2 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="mt-6">
                ...
                <div className="flex space-x-4">
                  {['facebook', 'twitter', 'instagram', 'linkedin'].map((social, i) => (
                    <a key={i} href={`https://${social}.com`} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-emerald-600 transition-colors duration-300">
